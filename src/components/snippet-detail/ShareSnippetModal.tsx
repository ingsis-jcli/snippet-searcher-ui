      ...
      <ModalWrapper open={open} onClose={onClose}>
        ...
        <Box mt={2}>
          ...
          <Box mt={4} display={"flex"} width={"100%"} justifyContent={"flex-end"}>
            ...
            <Button sx={{backgroundColor: '#7281f6', marginLeft: 2}} disabled={!selectedUser || loading} onClick={() => selectedUser && onShare(selectedUser?.id)}  variant={"contained"}>Share</Button>
          </Box>
        </Box>
      </ModalWrapper>
  )
